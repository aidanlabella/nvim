...
call s:hi_all([
\ ['BufferCurrent',        g:dracula#palette.pink,  bg_current],
\ ['BufferCurrentIndex',   g:dracula#palette.cyan,  bg_current],
\ ['BufferCurrentMod',     g:dracula#palette.green, bg_current],
\ ['BufferCurrentSign',    fg_special,  bg_current],
\ ['BufferCurrentTarget',  fg_target,   bg_current,   'bold'],
\ ['BufferVisible',        fg_visible,  bg_visible],
\ ['BufferVisibleIndex',   g:dracula#palette.cyan,  bg_visible],
\ ['BufferVisibleMod',     g:dracula#palette.green, bg_visible],
\ ['BufferVisibleSign',    fg_visible,  bg_visible],
\ ['BufferVisibleTarget',  fg_target,   bg_visible,   'bold'],
\ ['BufferInactive',       fg_current, bg_visible],
\ ['BufferInactiveIndex',  fg_current,   bg_visible],
\ ['BufferInactiveMod',    g:dracula#palette.green, bg_visible],
