...
local mappings = 
{
    ...
    { "<leader>de", "<cmd>Trouble diagnostics filter.severity=vim.diagnostic.severity.ERROR<cr>", desc = "Show errors", nowait = false, remap = false },
    { "<leader>dd", "<cmd>Trouble diagnostics toggle<cr>", desc = "Show diagnostic box", nowait = false, remap = false },
    { "<leader>db", "<cmd>Trouble diagnostics toggle filter.buf=0<cr>", desc = "Show diagnostic box for current buffer", nowait = false, remap = false },
    { "<leader>dl", "<cmd>Trouble lsp toggle focus=false win.position=right<cr>", desc = "Refresh", nowait = false, remap = false },
    ...
    { "<leader>ft", ":NvimTreeToggle<CR>", desc = "File Split (Oil)", nowait = false, remap = false },
    { "<leader>fe", ":vnew<CR>:Oil<CR>", desc = "File Split (Oil)", nowait = false, remap = false },
    ...
    { "<leader>th", "<cmd>bprevious<cr>", desc = "Prev. Tab", nowait = false, remap = false },
    { "<leader>tk", "<cmd>bdelete<cr>", desc = "Kill Tab", nowait = false, remap = false },
    { "<leader>tl", "<cmd>bnext<cr>", desc = "Next Tab", nowait = false, remap = false },
    { "<leader>tn", "<cmd>enew<cr>", desc = "New Tab", nowait = false, remap = false },
